...
<h1 style = "text-align:center; margin-top:10px;">Haitai Snack List</h1>
<div style = "width:1000px; height:830px; border:2px solid green; margin:20px auto; overflow:auto; padding:20px 10px;">
