...
<form class="row g-3" action = "/MemberJoin.go">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="userAddress01" placeholder="Road/Jibun Address" name = "address01">
  </div>
  
  <div class="col-12">
    <label for="userAddress02" class="form-label">Address 2</label>
    <input type="text" class="form-control" id="userAddress02" placeholder="Apartment, villa, etc" name = "address02">
  </div>
  
   <div class="col-md-4 mb-3">
    <label for="inputAgespan" class="form-label">Age</label>
    <select id="inputAgespan" class="form-select" name = "age">
